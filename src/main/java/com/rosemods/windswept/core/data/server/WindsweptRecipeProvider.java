...
public class WindsweptRecipeProvider extends BlueprintRecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output, HolderLookup.Provider holderLookup) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, WHITE_PINECONE_SHINGLES.get(), 8).define('D', Items.WHITE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(WHITE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, LIGHT_GRAY_PINECONE_SHINGLES.get(), 8).define('D', Items.LIGHT_GRAY_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(LIGHT_GRAY_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, GRAY_PINECONE_SHINGLES.get(), 8).define('D', Items.GRAY_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(GRAY_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BLACK_PINECONE_SHINGLES.get(), 8).define('D', Items.BLACK_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(BLACK_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BROWN_PINECONE_SHINGLES.get(), 8).define('D', Items.BROWN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(BROWN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, RED_PINECONE_SHINGLES.get(), 8).define('D', Items.RED_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(RED_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ORANGE_PINECONE_SHINGLES.get(), 8).define('D', Items.ORANGE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(ORANGE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, YELLOW_PINECONE_SHINGLES.get(), 8).define('D', Items.YELLOW_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(YELLOW_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, LIME_PINECONE_SHINGLES.get(), 8).define('D', Items.LIME_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(LIME_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, GREEN_PINECONE_SHINGLES.get(), 8).define('D', Items.GREEN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(GREEN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, CYAN_PINECONE_SHINGLES.get(), 8).define('D', Items.CYAN_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(CYAN_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, LIGHT_BLUE_PINECONE_SHINGLES.get(), 8).define('D', Items.LIGHT_BLUE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(LIGHT_BLUE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, BLUE_PINECONE_SHINGLES.get(), 8).define('D', Items.BLUE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(BLUE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, PURPLE_PINECONE_SHINGLES.get(), 8).define('D', Items.PURPLE_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(PURPLE_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, MAGENTA_PINECONE_SHINGLES.get(), 8).define('D', Items.MAGENTA_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(MAGENTA_PINECONE_SHINGLES.get()));
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, PINK_PINECONE_SHINGLES.get(), 8).define('D', Items.PINK_DYE).define('#', PINECONE_SHINGLES.get()).pattern("###").pattern("#D#").pattern("###").unlockedBy(getHasName(PINECONE_SHINGLES.get()), has(PINECONE_SHINGLES.get())).save(output, getSaveLocation(PINK_PINECONE_SHINGLES.get()));
