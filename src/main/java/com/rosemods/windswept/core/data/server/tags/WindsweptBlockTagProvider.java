...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.STONE_ORE_REPLACEABLES).add(SHALE.get(), ARKOSE.get());
        this.tag(BlockTags.BASE_STONE_OVERWORLD).add(SHALE.get(), ARKOSE.get());
        ...
        this.tag(TagUtil.blockTag("minecraft", "lanterns")).add(ICE_LANTERN.get());
        this.tag(TagUtil.blockTag("minecraft", "chains")).add(ICE_CHAIN.get());
