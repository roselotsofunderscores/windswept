...
public class WindsweptBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.TALL_FLOWERS).add(RED_ROSE_BUSH.get(), BLUE_ROSE_BUSH.get(), WHITE_ROSE_BUSH.get(), YELLOW_ROSE_BUSH.get(), LUPINE.get(), LIONS_TAIL.get());
        this.tag(BlockTags.REPLACEABLE).add(SNOWY_SPROUTS.get(), GELISOL_GRASS.get(), DRY_MOSSY_SPROUTS.get(), MOSSY_SPROUTS.get());
