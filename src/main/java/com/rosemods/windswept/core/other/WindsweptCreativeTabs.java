    ...
    public static void setupTabEditors() {
        CreativeModeTabContentsPopulator.mod(Windswept.MOD_ID)
                ...
                .addItemsAfter(Ingredient.of(Blocks.POLISHED_ANDESITE_SLAB), SHALE, SHALE_STAIRS, SHALE_SLAB, SHALE_WALL, POLISHED_SHALE, POLISHED_SHALE_STAIRS, POLISHED_SHALE_SLAB, POLISHED_SHALE_WALL,
                        ...
                        ARKOSE, ARKOSE_STAIRS, ARKOSE_SLAB, ARKOSE_WALL, POLISHED_ARKOSE, POLISHED_ARKOSE_STAIRS, POLISHED_ARKOSE_SLAB, POLISHED_ARKOSE_WALL, ARKOSE_BRICKS, ARKOSE_BRICK_STAIRS, ARKOSE_BRICK_SLAB, ARKOSE_BRICK_WALL,
                        ARKOSE_TILES, ARKOSE_TILE_STAIRS, ARKOSE_TILE_SLAB, ARKOSE_TILE_WALL, ARKOSE_PILLAR)
