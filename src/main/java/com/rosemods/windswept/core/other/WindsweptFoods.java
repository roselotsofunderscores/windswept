...
public final class WindsweptFoods {
    ...
    public static final FoodProperties GOAT_STEW = new FoodProperties.Builder().nutrition(9).saturationModifier(.9f).build();
    public static final FoodProperties CHESTNUT_SOUP = new FoodProperties.Builder().nutrition(7).saturationModifier(.5f).build();
    public static final FoodProperties FROZEN_FLESH = new FoodProperties.Builder().nutrition(4).saturationModifier(.1f).effect(() -> new MobEffectInstance(MobEffects.HUNGER, 600, 0), .8f).meat().build();
    ...
    public static final FoodProperties GINGERBREAD_COOKIE = new FoodProperties.Builder().nutrition(2).fast().saturationModifier(.1f)/*.effect(() -> new MobEffectInstance(WindsweptEffects.PLENTY.get(), 200, 0), 1f)*/.build();
    public static final FoodProperties SPICY_SNOW_CONE = new FoodProperties.Builder().nutrition(15).alwaysEdible().saturationModifier(.6f).effect(() -> new MobEffectInstance(WindsweptEffects.FROST_RESISTANCE.get(), 300, 0), 1f).build();
    ...
    public static final FoodProperties MINY_SNOW_CONE = new FoodProperties.Builder().nutrition(15).alwaysEdible().saturationModifier(.6f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 300, 0), 1f).build();
