...
public final class WindsweptBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<SuspiciousSnowBlockEntity>> SUSPICIOUS_SNOW = BLOCK_ENTITIES.createBlockEntity("suspicious_snow", SuspiciousSnowBlockEntity::new, () -> Set.of(WindsweptBlocks.SUSPICIOUS_SNOW.get()));    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<WillOTheWispBlockEntity>> WILL_O_THE_WISP = BLOCK_ENTITIES.createBlockEntity("will_o_the_wisp", WillOTheWispBlockEntity::new, () -> Set.of(WindsweptBlocks.WILL_O_THE_WISP.get()));
