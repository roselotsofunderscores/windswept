...
public final class WindsweptBlocks {
    ...
    public static final DeferredBlock<Block> NIGHTSHADE_BOUQUET = BLOCKS.createBlockWithItem("nightshade_bouquet", () -> new NightshadeBouquetBlock(Block.Properties.of().instabreak().sound(SoundType.AZALEA).noCollission().lightLevel(state -> 9)), () -> new WearableBlockItem(WindsweptBlocks.NIGHTSHADE_BOUQUET.get(), new Item.Properties()));
