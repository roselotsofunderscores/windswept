...
public final class WindsweptBoatTypes {
    public static final BoatloadBoatType HOLLY = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.location("holly"), () -> WindsweptBlocks.HOLLY_PLANKS.asItem(), () -> WindsweptItems.HOLLY_BOAT.getFirst().get(), () -> WindsweptItems.HOLLY_BOAT.getSecond().get(), () -> WindsweptItems.HOLLY_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_HOLLY_BOAT.get()));
    public static final BoatloadBoatType CHESTNUT = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.location("chestnut"), () -> WindsweptBlocks.CHESTNUT_PLANKS.asItem(), () -> WindsweptItems.CHESTNUT_BOAT.getFirst().get(), () -> WindsweptItems.CHESTNUT_BOAT.getSecond().get(), () -> WindsweptItems.CHESTNUT_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_CHESTNUT_BOAT.get()));
    public static final BoatloadBoatType PINE = BoatloadBoatType.register(BoatloadBoatType.create(Windswept.location("pine"), () -> WindsweptBlocks.PINE_PLANKS.asItem(), () -> WindsweptItems.PINE_BOAT.getFirst().get(), () -> WindsweptItems.PINE_BOAT.getSecond().get(), () -> WindsweptItems.PINE_FURNACE_BOAT.get(), () -> WindsweptItems.LARGE_PINE_BOAT.get()));
