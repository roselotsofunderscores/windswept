...
public final class WindsweptMilkCauldronInteractions {
    public static void registerCauldronInteractions() {
        ...
        CauldronInteraction.EMPTY.map().put(WindsweptItems.WOODEN_MILK_BUCKET.get(), WindsweptMilkCauldronInteractions::fillMilkCauldron);
    }

    private static ItemInteractionResult fillMilkCauldron(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, ItemStack stack) {
    ...
    private static ItemInteractionResult emptyMilkCauldron(BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, ItemStack stack) {
        if (NeapolitanConfig.COMMON.milkCauldron.get())
